...
当前复核（2026-08-20）：工作区现有 19 个 publishable packages，逐包测试数以生成证据
[`evidence/current-test-counts.json`](evidence/current-test-counts.json) 为准。下方 17 包和当阶段
测试数字是 2026-08-12 的历史快照，不代表当前工作区总数。
