...
const ZH_CN: PlayerUiLabels = {
  ...
  troubleshootHealthy: '没有检测到播放问题。', troubleshootFindings: '检测结果', troubleshootDroppedFrames: '正在丢帧。请降低分辨率、关闭其他占用 GPU 的标签页，或把播放意图切回 Normal。', troubleshootBuffering: '数据供给不足。请检查网络，并确认服务端对 HTTP Range 请求返回 206 Partial Content。', troubleshootError: '引擎报告了错误，下面的错误码指向失败的阶段。', troubleshootNoAudioClock: '音频时钟未运行，视频时序改用媒体墙钟，可能出现漂移。', troubleshootSoftwareDecode: '当前使用 WASM 解码器。这个 Codec 在此浏览器上没有硬件解码。',
  troubleshootUnsupportedVideoCodec: '这个视频编码在此处无法解码。H.264、VP8、VP9、AV1 可以播放，HEVC 不行。',
  troubleshootUnsupportedAudioCodec: '这个音频编码在此处无法解码。AAC、Opus、MP3 可以播放，AC-3、DTS、FLAC、Vorbis 不行。',
...
const ZH_TW: PlayerUiLabels = {
  ...
  troubleshootHealthy: '沒有偵測到播放問題。', troubleshootFindings: '偵測結果', troubleshootDroppedFrames: '正在丟影格。請降低解析度、關閉其他佔用 GPU 的分頁，或把播放意圖切回 Normal。', troubleshootBuffering: '資料供給不足。請檢查網路，並確認伺服器對 HTTP Range 請求回傳 206 Partial Content。', troubleshootError: '引擎回報了錯誤，下面的錯誤碼指向失敗的階段。', troubleshootNoAudioClock: '音訊時鐘未運行，影片時序改用媒體牆鐘，可能出現漂移。', troubleshootSoftwareDecode: '目前使用 WASM 解碼器。這個 Codec 在此瀏覽器上沒有硬體解碼。',
  troubleshootUnsupportedVideoCodec: '這個視訊編碼在此處無法解碼。H.264、VP8、VP9、AV1 可以播放，HEVC 不行。',
  troubleshootUnsupportedAudioCodec: '這個音訊編碼在此處無法解碼。AAC、Opus、MP3 可以播放，AC-3、DTS、FLAC、Vorbis 不行。',
...
const JA: PlayerUiLabels = {
  ...
  troubleshootUnsupportedVideoCodec: 'この映像コーデックはここではデコードできません。H.264、VP8、VP9、AV1 は再生できますが、HEVC はできません。',
  troubleshootUnsupportedAudioCodec: 'この音声コーデックはここではデコードできません。AAC、Opus、MP3 は再生できますが、AC-3、DTS、FLAC、Vorbis はできません。',
