...
export const ErrorCodes = {
  ...
  WASM_MANIFEST_INVALID: 'WASM_MANIFEST_INVALID',
  WASM_PLUGIN_DUPLICATE: 'WASM_PLUGIN_DUPLICATE',
  WASM_PLUGIN_NOT_FOUND: 'WASM_PLUGIN_NOT_FOUND',
  WASM_VARIANT_UNAVAILABLE: 'WASM_VARIANT_UNAVAILABLE',
  WASM_URL_INVALID: 'WASM_URL_INVALID',
  WASM_FETCH_FAILED: 'WASM_FETCH_FAILED',
  WASM_HASH_MISMATCH: 'WASM_HASH_MISMATCH',
  WASM_CACHE_FAILED: 'WASM_CACHE_FAILED',
  ...
  WASM_PLUGIN_INIT_FAILED: 'WASM_PLUGIN_INIT_FAILED',
  WASM_REVIEW_REQUIRED: 'WASM_REVIEW_REQUIRED',
  WASM_ABORTED: 'WASM_ABORTED',
  WASM_CLOSED: 'WASM_CLOSED',
  WASM_ALL_VARIANTS_FAILED: 'WASM_ALL_VARIANTS_FAILED',
