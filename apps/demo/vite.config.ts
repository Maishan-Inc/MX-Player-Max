...
const QUALITY_ASSETS = new Map([
  ...
  ['mkv-vp9-p0-8bit-opus.mkv', { path: fileURLToPath(new URL('mkv-vp9-p0-8bit-opus.mkv', QUALITY_FIXTURE_DIRECTORY)), type: 'video/x-matroska' }],
  ['mkv-av1-p0-8bit-opus.mkv', { path: fileURLToPath(new URL('mkv-av1-p0-8bit-opus.mkv', QUALITY_FIXTURE_DIRECTORY)), type: 'video/x-matroska' }],
  ['mkv-vp9-p2-10bit-opus.mkv', { path: fileURLToPath(new URL('mkv-vp9-p2-10bit-opus.mkv', QUALITY_FIXTURE_DIRECTORY)), type: 'video/x-matroska' }],
  ['mkv-h264-baseline-8bit-aac-embedded-ass.mkv', { path: fileURLToPath(new URL('mkv-h264-baseline-8bit-aac-embedded-ass.mkv', QUALITY_FIXTURE_DIRECTORY)), type: 'video/x-matroska' }],
